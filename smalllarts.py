...
@Freaky.on(Freaky_on_cmd(pattern=r"spika"))
async def kakashi(pikachu):
    await pikachu.edit(A)


@Freaky.on(Freaky_on_cmd(pattern=r"sshit"))
async def kakashi(shit):
    await shit.edit(B)


@Freaky.on(Freaky_on_cmd(pattern=r"sxx"))
async def kakashi(saxy):
    await saxy.edit(C)


@Freaky.on(Freaky_on_cmd(pattern=r"sporn"))
async def kakashi(pornhub):
    await pornhub.edit(D)


@Freaky.on(Freaky_on_cmd(pattern=r"sthink"))
async def kakashi(think):
    await think.edit(E)


@Freaky.on(Freaky_on_cmd(pattern=r"sdick"))
async def kakashi(dick):
    await dick.edit(F)


@Freaky.on(Freaky_on_cmd(pattern=r"sfrog"))
async def kakashi(frog):
    await frog.edit(G)


@Freaky.on(Freaky_on_cmd(pattern=r"sputin"))
async def kakashi(putin):
    await putin.edit(H)


@Freaky.on(Freaky_on_cmd(pattern=r"sdead"))
async def kakashi(dead):
    await dead.edit(I)


@Freaky.on(Freaky_on_cmd(pattern=r"strump"))
async def kakashi(trump):
    await trump.edit(J)


@Freaky.on(Freaky_on_cmd(pattern=r"schina"))
