...
async def _(event):
    ...
    if input_str == "chod":
        ...
        animation_chars = [
            ...
            "`Fucking Your Mom\n\n\nYour Mom's Pussy Get Red\nCumming On Pussy\n\nYour mom get Pregnant\n\nResult: Now You Have 1 More Younger Brother, Name : Denzid `",
        ]
...
async def _(event):
    ...
    if input_str == "sqh":
        ...
        animation_chars = [
            ...
            "`Quick Heal Total Security Checkup\n\n\nSubscription: Peru User\nValid Until: 31/12/2099\n\nFile Scanned... 84%\n█████████████████████▒▒▒▒ `",
            "`Quick Heal Total Security Checkup\n\n\nSubscription: Peru User\nValid Until: 31/12/2099\n\nFile Scanned... 100%\n█████████████████████████ `",
            "`Quick Heal Total Security Checkup\n\n\nSubscription: Peru User\nValid Until: 31/12/2099\n\nTask: 01 of 01 Files Scanned...\n\nReault: A virus Named Denzid Found...Cleaning it...`",
        ]
...
async def _(event):
    ...
    if input_str == "quickheal":
        ...
        animation_chars = [
            ...
            "`Quick Heal Total Security Checkup\n\n\nSubscription: Peru User\nValid Until: 31/12/2099\n\nFile Scanned... 84%\n█████████████████████▒▒▒▒ `",
            "`Quick Heal Total Security Checkup\n\n\nSubscription: Peru User\nValid Until: 31/12/2099\n\nFile Scanned... 100%\n█████████████████████████ `",
            "`Quick Heal Total Security Checkup\n\n\nSubscription: Peru User\nValid Until: 31/12/2099\n\nTask: 01 of 01 Files Scanned...\n\nReault:⚠️Virus Found⚠️\nMore Info: Torzan, Spyware, Adware, Denzid`",
        ]
